 ...
 * @author Alex Malotky
 */
import { createElement as _, Element as Content } from "@/util/Element";
 ...
 * 
 */
export default class CatagoryList extends HTMLElement{
...
customElements.define("catagory-list", CatagoryList);
...
export function CardElement(card:Card, loadList?:Array<Promise<HTMLElement>>): Content{
    ...
    output.addEventListener("click", (event)=>(event.target as HTMLElement).focus());
